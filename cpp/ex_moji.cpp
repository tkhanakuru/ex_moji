// ex_moji.cpp : アプリケーションのエントリ ポイントを定義します。
//
                     ...
                     _In_ int       nCmdShow)
{
    ...
    LoadStringW(hInstance, IDC_EXMOJI, szWindowClass, MAX_LOADSTRING);
